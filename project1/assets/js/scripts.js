  ...
  //make ajax call to get getcountryInfo.php
		$.ajax({
          ...
          //linking the results with , appropriate modal IDs in the HTML File
					...
					$('#population').html(result['data'][0]['geonameId']);
...
// Wiki Modal
function getWikiInfo(countryCode){
		$.ajax({
  ...
  $.ajax({
    ...
    success: function(result) {
      ...
      if (result.status.name == "ok") {
        console.log(result);
        //linking the results with , appropriate modal IDs in the HTML File
        $('#txtTime').html(result['geonames'][0]['summary']);
        $('#txtTimezone').html(result['geonames'][0]['wikipediaUrl']);    
      }
  ...
  $.ajax({
    ...
    success: function(result) {
      ...
      if (result.status.name == "ok") {
        ...
        $('#textTemp').html(result['main'][0]['temp']);      
      }
  ...
  $.ajax({
    ...
    success: function(result) {
      ...
      if (result.status.name == "ok") {
        console.log(result);
        //linking the results with , appropriate modal IDs in the HTML File
        $('#textWeather').html(result['results'][0]['roadinfo']["drive_on"]);
        $('#textWeather').html(result['results'][0]['roadinfo']["speed_in"]);             
      }
