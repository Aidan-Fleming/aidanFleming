<?php 
    ...
    $query = 'SELECT personnel.id, personnel.lastName, personnel.firstName, department.name AS departmentName, location.name AS locationName, personnel.jobTitle, personnel.email
    FROM personnel
